...
void SendMotion(FbxScene* scene, SOCKET MotionSocket, SOCKET FacialSocket, char* RecvBuf)
{
	int motionReset = 0;
	int facialReset = 0;
...
//						float value = key.GetValue();
//
//						if (channelIndex == 2 || channelIndex == 17 || channelIndex == 19 || channelIndex == 20 || channelIndex == 24 || channelIndex == 25 || channelIndex == 26 || channelIndex == 27 || channelIndex == 28 || channelIndex == 29 || channelIndex == 35 || channelIndex == 36 || channelIndex == 41 || channelIndex == 42 || channelIndex == 46 || channelIndex == 47 || channelIndex == 69 || channelIndex == 70 || channelIndex == 74)
//						{
//							float FacialData = value;
//							unsigned char Bytes[4];
//							memcpy(Bytes, &FacialData, 4);
...
int main()
{
	...
	while (true)
	{
		...
		thread motionThread(SendMotion, scene, MotionSocket, FacialSocket, RecvBuf);
