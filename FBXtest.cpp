...
int main_2()
{
	...
	const char* fbxFilePath = "C:/FBXtest/Tut_Hip_Hop_Dance_fix_Anim_mixamo_com.fbx";
		...
		for (int i = 0; i < childCount; ++i)
		{
			...
			for (int j = 0; j < deformerCount; ++j)
			{
				...
				for (int k = 0; k < clusterCount; ++k)
				{
					...
					if(k == 1 || k == 2 || k == 3 || k == 4 || k == 5 || k == 6 || k == 7 || k == 8 || k == 9 || k == 10 || k == 11 || k == 32 || k == 33 || k == 34 || k == 35 || k == 56 || k == 57 || k == 58 || k == 61 || k == 62 || k == 63)
					{
